...
plot_fisher<-function(fish_data,fishermen_data){
 ...
 fishermen_map<-ggplot() + geom_sf(data = fish_data,aes(fill=fish_density_start))+
  ...
  geom_sf_label(data= fisher_grid,aes(label = fisher_grid$fishermen_id), label.padding = unit(0.1, "mm"))
...
```{r}
Kinneret<-st_read("C:\\Users\\nimrodelk\\Documents\\PHD\\Kineret\\gis\\kinneret polygon self based on bing WGS 84.shp")
